...
public class WLocate implements Runnable {
    ...
    /**
     * Don't perform any network accesses to evaluate the position data, this option disables the WLAN_based position retrieval
     */
    public static final int FLAG_NO_GPS_ACCESS = 0x0002;
    /**
     * Don't use a GPS device to evaluate the position data, this option disables the WLAN_based position retrieval
     */
    public static final int FLAG_NO_IP_LOCATION = 0x0004;
    /**
     * Don't send a request to the server for IP-based location in case no WLANs are available
     */
    ...
    /**
     * Result code for position request, an unknown error occured, no position information are available
     */
...
//   private static final int WLOC_RESULT_IERROR=3;
    ...
    class WifiReceiver extends BroadcastReceiver {
        public void onReceive(Context c, Intent intent) {
            ...
            if (GPSAvailable)
                GPSAvailable = (SystemClock.elapsedRealtime() - lastLocationMillis) < 7500;
            if (!GPSAvailable) {
